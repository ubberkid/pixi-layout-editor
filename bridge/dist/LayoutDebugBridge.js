...
export class LayoutDebugBridge {
    ...
    setProperty(id, property, value) {
        ...
        if (property === '_layoutEnabled') {
            ...
            const disableData = typeof value === 'object' && value !== null ? value : null;
            if (enabling) {
                ...
                if (disableData?.restoreTransform) {
                    ...
                    if (transform.pivotX !== undefined)
                        container.pivot.x = transform.pivotX;
                    if (transform.pivotY !== undefined)
                        container.pivot.y = transform.pivotY;
                    if (transform.alpha !== undefined)
                        container.alpha = transform.alpha;
                    if (transform.anchorX !== undefined && "anchor" in container) {
                        container.anchor.x = transform.anchorX;
                    }
                    if (transform.anchorY !== undefined && "anchor" in container) {
                        container.anchor.y = transform.anchorY;
                    }
                }
            }
